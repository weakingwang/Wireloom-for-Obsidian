...
本项目基于 [MIT License](LICENSE) 开源，完整条款见仓库根目录的 [LICENSE](LICENSE) 文件。
...
- [A quick preview](#a-quick-preview)
...
This project is open source under the [MIT License](LICENSE). See the [LICENSE](LICENSE) file in the repository root for the full terms.
