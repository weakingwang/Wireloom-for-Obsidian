...
- **Wireloom official repository**: https://github.com/stardock/wireloom
- **Wireloom online editor**: https://wireloom.dev (if available)
- **Obsidian plugin development docs**: https://docs.obsidian.md/Plugins/Getting+started
- **Mermaid** (similar text-based diagramming tool): https://mermaid.js.org
- **json-render** (framework for AI-generated real UI): https://github.com/vercel-labs/json-render
...
- **Wireloom 在线编辑器**：https://wireloom.dev （如果可用）
- **Obsidian 插件开发文档**：https://docs.obsidian.md/Plugins/Getting+started
- **Mermaid**（类似的文本图表工具）：https://mermaid.js.org
- **json-render**（用于 AI 生成真实 UI 的框架）：https://github.com/vercel-labs/json-render
